...
import { studentHeaderMenuItems } from '@/shared/constants/menu'
                     ...
                     p-3 backdrop-blur-lg rounded-full cursor-pointer relative
                      hover:bg-surface transition-all duration-300'>
                        ...
                        <div
                            ...
                            className='flex items-center gap-3 cursor-pointer mx-5 relative'>
                            <div className='flex items-center gap-1.5 lg:gap-3 capitalize'>

                                <div className='h-8 w-8 rounded-full bg-surface
                             font-bold text-md flex items-center justify-center
